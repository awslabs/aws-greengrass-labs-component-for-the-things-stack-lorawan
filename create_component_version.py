...
"""
Creates a new version of The Things Stack LoRaWAN component in the Greengrass cloud service.
...
3) Configure the LoRaWAN stack (https://www.thethingsindustries.com/docs/getting-started/installation/configuration/)
   (or generate a minimal configuration with create_config_miniaml.py)
4) If using an Enterprise license file, add it to the tts-config directory
5) Create or update The Things Stack secret by running create_config_secret.py
...
BUCKET_NAME = 'greengrass-tts-lorawan-' + ACCOUNT
