...
export class CicdStack extends cdk.Stack {
    ...
    private getContext(): CicdStackContext {
        ...
        const repositoryName        = this.getContextVariable('RepositoryName',     'Name of the repository containing the source code (Default: aws-greengrass-labs-component-for-the-things-stack-lorawan)');
        const branchName            = this.getContextVariable('BranchName',         'Name of the branch to use in the repository (Default: main)');
        const greengrassCoreName    = this.getContextVariable('GreengrassCoreName', 'Name of the Greengrass core device to which the component should be deployed');
