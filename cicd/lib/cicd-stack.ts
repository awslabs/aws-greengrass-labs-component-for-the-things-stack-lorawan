...
enum Names {
    ...
    COMPONENT = 'aws.greengrass.labs.TheThingsStackLoRaWAN',
    COMPONENT_BUCKET = 'greengrass-tts-lorawan',
...
export class CicdStack extends cdk.Stack {
    ...
    private getContext(): CicdStackContext {
        ...
        const greengrassCoreName    = this.getContextVariable('GreengrassCoreName',     'Name of the Greengrass core device to which The Things Stack component should be deployed');
